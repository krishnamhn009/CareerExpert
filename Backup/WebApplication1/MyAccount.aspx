...
<div class="container margin-top-30">
    ...
    <ul class="nav nav-tabs margin-top-15 page-header">
        ...
        <li id="lblJobs" ><a data-toggle="tab" href="#menu1" ><i class="fa fa-suitcase fa-2x" style="color: #004466; margin-right:.1em;"></i>Applied Jobs
        <span class="badge btn-lg btn-primary "><asp:Label id="jobAppliedCount" runat="server"/></span>
        </a></li>
        <li id="lblRefer" ><a data-toggle="tab" href="#menu2"><i class="fa fa-users fa-2x" style="color: #004466; margin-right:.1em;"></i>Refer and Earn Referrals</a></li>
        <li runat="server" id="adminPanel" visible="false"><a href="dev"><i class="fa fa-user-secret fa-2x" style="color: #004466; margin-right:.1em;" ></i>Admin</a></li>         
    </ul>
  ...
  aria-valuemin="0" aria-valuemax="100" style="width:70%">
    <label runat="server" id="lblProgress"></label>
              ...
              <div class="panel-body h5" style=" color: #004466;" runat="server" id="showProfile">
                    ...
                    <div class="form-group control-label col-sm-6">
                        <i class="fa fa-building fa-2x" style="margin-right:.1em;"></i>
                        <label id="lCompany"  runat="server">
                        </label>
                    </div>
                    <div class="form-group control-label col-sm-6">
                        <i class="fa fa-star-half-o fa-2x" style="margin-right:.1em;"></i>
                    ...
                    <div class="form-group control-label col-sm-6">
                        <i class="fa fa-file-archive-o fa-2x" style="margin-right:.1em;"></i>
